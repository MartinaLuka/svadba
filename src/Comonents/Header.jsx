    ...
    return (
        <Flex w={'100%'}>
            <Box ref={ref} position={'relative'} id="header" className="website-breeze__cover" style={{backgroundImage:`url(${image})`, height: 'auto', backgroundSize: 'cover', backgroundPosition: 'center center', width: '100%' }}>
                ...
                {/*    </Box>*/}
                {/*</Box>*/}
                <Box  w={'90%'}  position={'absolute'} top={screenSize.width < 928 ? screenSize.width < 366 ? `${height - 50}px` : `${height - 50}px` : `${height - 50}px`} ><h2 className="website-breeze__cover-h2 website-breeze__editable" style={{width: 'fit-content'}}>
